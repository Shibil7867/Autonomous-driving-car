...
void loop() {                                                                                //This part of the code runs in a loop indefinitely.
  ...
  {                                                                                          //
    ...
    {                                                                                        //
      ...
      mot = map(mot,0,1023,0,240);                                                           //The value between 0-1023 is converted to a value between 0-240 for PWM.
      if (mot<120)                                                                            //If the converted value is lesser than 120,the car should go right.
      {                                                                                      //
        val_1 = 120+120-mot;                                                                   //The PWM value for the left motor(+240 to 0).
        val_2 = 3*mot-240;                                                                   //The PWM value for the right motor(+120 to -120).
      ...
      else                                                                                   //If the value is greater than 120, the car should go left.
      {                                                                                      //
        val_2 = mot;                                                                         //The PWM value for the right motor. 
        val_1 = 480-3*mot;                                                                   //The PWM value for the left motor.
